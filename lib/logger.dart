                ...
                if (docId == null) {
                  ...
                  if (docId == null) {
                    if (selectedCategory == 'sensor') {
                      firestoreServices.addSensor(logger, quantity, price, sku, selectedCategory);
                    }
                    if (selectedCategory == 'logger') {
                      firestoreServices.addLogger(logger, quantity, price, sku, selectedCategory);
                    }
                    if (selectedCategory == 'component') {
                      firestoreServices.addComponent(logger, quantity, price, sku, selectedCategory);
                    }
                  } else {
                    firestoreServices.updateLoggers(docId, logger, quantity, price, sku, selectedCategory, time!);
                  }
          // Update logger
                } else {
                  final logger = controller.text.trim();
        ...
        items: ['sensor', 'logger', 'component']
          ...
          onChanged: (value) {
            ...
            Expanded(
              // Show Loggers
              child: StreamBuilder(
                stream: FirestoreServices().showLoggers(),
                                            ...
                                            actions: [
                                              ...
                                              TextButton(onPressed: () {
                                                ...
                                                if (qtytoDelete > 0 && qtytoDelete <= quantity) {
                                                  ...
                                                  if (newQty > 0) {
                                                    firestoreServices.updateLoggers(docId, logger, newQty, price, sku, selectedCategory, time);
                                                  } else {
                                                    firestoreServices.deleteLogger(docId);
                                                  }
