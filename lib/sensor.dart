...
//                       firestoreServices.addProduct(item, quantity, price, sku, selectedCategory);
//                     }
...
//                     }
//                   } else {
//                     firestoreServices.updateProducts(docId, item, quantity, price, sku, selectedCategory, time!);
//                   }
//           // Update Sensor
//                 } else {
...
//                   firestoreServices.updateProducts(docId, sensor, quantity, price, sku, selectedCategory, time!);
//                 }
//                 controller.clear();
...
//                                                   if (newQty > 0) {
//                                                     firestoreServices.updateProducts(docId, sensor, newQty, price, sku, selectedCategory, time);
//                                                   } else {
